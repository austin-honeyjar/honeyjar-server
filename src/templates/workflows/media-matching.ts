...
GOAL:
Use AI to generate a list of 10 authors who are likely to write about the specified topic based on expertise and industry knowledge.

CONTEXT:
You will receive the topic from Step 1. Your job is to generate relevant author suggestions who typically write about this topic.
...
5. Prepare author list for Metabase article searches
...
3. Use this exact format for nextQuestion:
...
4. Make sure the nextQuestion shows the SAME author names that are in your suggestedAuthors array
5. IMPORTANT: Always return "isComplete": true to auto-proceed to the next step
6. Never ask for user confirmation - the workflow should flow seamlessly
